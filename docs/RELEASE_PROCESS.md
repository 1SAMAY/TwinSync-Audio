...
4. Review `release\v0.1.0\BUILD_REPORT.md`.
5. Review `release\v0.1.0\TEST_REPORT.md`.
6. Install `TwinSyncAudio-Setup-v0.1.0.exe` on a clean Windows test machine.
7. Test real Bluetooth/audio playback, synchronization, profile save/load, shutdown, uninstall, and reinstall.
8. Create and push tag `v0.1.0` only after the manual checks pass.
9. Create a GitHub release titled `TwinSync Audio v0.1.0`.
